...
# its values, to check that your ranges are what yuo expected.
# You may also want to include thinks like.
...
# for loop to print out the values of o to see why p return what it does
